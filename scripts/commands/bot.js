...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users }) {
    try {
      ...
      if (!msg) {
        const greetings = [
          "__আমাকে এতো না ডেকে বস 𝐅𝐀𝐇𝐈𝐌 𝐂𝐇𝐎𝐖𝐃𝐇𝐔𝐑𝐘 কে একটা গফ দে-🙄😌",
          ...
          "__আর কত বার ডাকবি ,শুনছি তো,🤭🙈",
          "__বালিকা━👸-𝐃𝐨 𝐲𝐨𝐮-🫵-বিয়া-𝐦𝐞-😽-আমি তোমাকে-😻-আম্মু হইতে সাহায্য করব-🙈🥱",
          "__আজকে প্রপোজ করে দেখো রাজি হইয়া যামু-😌🤗😇"
        ];
